  ...
  describe "#receive" do
    ...
    describe Order::Item[15, 'FLAC'] do
      specify "15 FLAC $1957.50" do
        ...
        expect(order.with_breakdowns)
          .to include Bundle['FLAC', 15, 1957.50] => [
                        Breakdown[1, Bundle['FLAC', 9, 1147.50]],
                        Breakdown[1, Bundle['FLAC', 6, 810]]
                      ]
      end
    end
    ...
    describe Order::Item[13, 'VID'] do
      specify "13 VID $2370" do
        ...
        expect(order.with_breakdowns)
          .to include Bundle['VID', 13, 2370] => [
                        Breakdown[2, Bundle['VID', 5, 900]],
                        Breakdown[1, Bundle['VID',  3, 570]]
                      ]
      end
    end
